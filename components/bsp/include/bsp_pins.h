...
// 充电状态检测脚由板级原理图决定。当前公开 ai-passport 引脚表未定义该信号，
// 保持 -1 时只显示 CW2017 的真实 SOC，并隐藏充电闪电，避免伪造状态。
#define BSP_BATTERY_CHARGE_GPIO          (-1)
#define BSP_BATTERY_CHARGE_ACTIVE_LEVEL  0
